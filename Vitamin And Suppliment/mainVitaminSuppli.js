          ...
          let imageArr=[
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Power-gummies-40-web.jpg"},
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/GB-Fresh-web.jpg"},
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Progut-Plus-web.jpg"},
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Medo-Specia-Migraine-web.jpg"},
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Milenium-Herbal-Care-web.jpg"},
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Swan-Banner_NavGrah-FBoost_1200x250_20-01-2022.jpg"},
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Add-Veda-Hair-1200x250.jpg"},
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Swan-corcal-Pack6-web.jpg"},
           ...
           async function getData() {
                ...
                try{
                   let res = await fetch(`../API's/vitamins and suppliments.json`)
              ...
              document.querySelector("#search1").addEventListener("click", myfunction1)
                ...
                displayData(x);
                  ...
                  // here we have filtered brand
                     ...
                     function myfunctionB1(Butterfly){
                         var serch = "Butterfly"
                     ...
                     function myfunctionB6(SleepRite){
                         var serch = "SleepRite"
                         var filterDeta = dt.filter(function(ele){
