          ...
          let imageArr=[
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/swan-ghee-web.jpg"},
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Swan-BA-Diabe-choice-cookies-Web.jpg"},
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Swan-BA-Desi-masala-Chai-web.jpg"},
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Swan-TruNative-Froat-web.jpg"},
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Swan-Neuherb-Apple-Cider-Web.jpg"},
           ...
           async function getData() {
                ...
                try{
                   let res = await fetch(`../API's/food and drinks.json`)
              ...
              document.querySelector("#search1").addEventListener("click", myfunction1)
                ...
                displayData(x);
                  ...
                  // here we have filtered brand
                     ...
                     function myfunctionB6(Vanantara){
                         var serch = "Vanantara"
                         var filterDeta = dt.filter(function(ele){
