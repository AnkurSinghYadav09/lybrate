          ...
          let imageArr=[
            {I:"https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Herbo-Turbo_Banner_1200x250_18-11-2021.jpg"},
            {I:"https://assets.lybrate.com/q_auto,f_auto/rio/Stemno-web4.jpg"},
           ...
           async function getData() {
                ...
                try{
                   let res = await fetch(`../API's/sexual wellness.json`)
              ...
              document.querySelector("#search1").addEventListener("click", myfunction1)
                ...
                displayData(x);
                  ...
                  // here we have filtered brand
                     ...
                     function myfunctionB1(Shilajit){
                         var serch = "Shilajit"
                     ...
                     function myfunctionB3(Butterfly){
                         var serch = "Butterfly"
                         var filterDeta = dt.filter(function(ele){
                     ...
                     function myfunctionB6(Ayurveda){
                         var serch = "Ayurveda"
                         var filterDeta = dt.filter(function(ele){
