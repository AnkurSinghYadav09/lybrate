          ...
          let imageArr=[
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Amaterasu-Soreze-Gel-1200x250.jpg"},
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Swan-Auggmin-Herbal-Vibe-Web.jpg"},
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Swan-Oxy-Deodorizing-web.jpg"},
           ...
           async function getData() {
                ...
                try{
                   let res = await fetch(`../API's/Personal Care.json`)
              ...
              document.querySelector("#search1").addEventListener("click", myfunction1)
                ...
                displayData(x);
                  ...
                  // here we have filtered brand
                     ...
                     function myfunctionB2(Greencure){
                         var serch1 = "Greencure"
