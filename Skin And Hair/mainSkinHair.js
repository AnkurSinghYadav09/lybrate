          ...
          let imageArr=[
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Oshea-Tan-removal-kit-Web.jpg"},
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/age-reverse-web.jpg"},
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/dull-skin-web.jpg"},
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Keeo-Kol-Face-Wash-web7.jpg"},
           ...
           async function getData() {
                ...
                try{
                   let res = await fetch(`../API's/skin and hair care.json`)
              ...
              document.querySelector("#search1").addEventListener("click", myfunction1)
                ...
                displayData(x);
                  ...
                  // here we have filtered brand
                     ...
                     function myfunctionB2(Organically){
                         var serch1 = "Love"
                     ...
                     function myfunctionB3(Gangakshi){
                         var serch = "Gangakshi"
                         var filterDeta = dt.filter(function(ele){
                     ...
                     function myfunctionB7(Fungicid){
                         var serch = "Fungicid"
                         var filterDeta = dt.filter(function(ele){
