          ...
          let imageArr=[
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/One-life-Mass-Gainer-Chocolate-1200x250.jpg"},
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Swan-Banner_Proburst-Web.jpg"},
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Swan-Banner_Nestle-Web.jpg"},
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Swan-Banner_Proburst-Web.jpg"},
           ...
           async function getData() {
                ...
                try{
                   let res = await fetch(`../API's/protein and fitness.json`)
              ...
              document.querySelector("#search1").addEventListener("click", myfunction1)
                ...
                displayData(x);
                  ...
                  // here we have filtered brand
                     ...
                     function myfunctionB1(Proburst){
                         var serch = "Proburst"
                     ...
                     function myfunctionB2(RiteBite){
                         var serch1 = "RiteBite"
