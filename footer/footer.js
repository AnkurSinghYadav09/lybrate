function footerfun()
{
    ...
    <div>
        <ul class="footer-list">
            <li class="footer-list-header"> Search Health Products </li>
            <li> Goodkart </li>
            <li> Vitamin and Supplement </li>
            <li> Protein and Fitness </li>
    ...
    <div>
        <ul class="footer-list">
            <li class="footer-list-header"> Search doctors </li>
            <li> Search doctors by city </li>
            <li> Search doctors by City Locality </li>
            <li> Search doctors by speciality </li>
            <li> Search doctors by city speciality </li>
        </ul>
    </div>
    <div>
        <ul class="footer-list">
            <li class="footer-list-header"> Read Health Articles </li>
            <li> Health Wiki </li>
            <li> Health Tips Index </li>
            <li> Health Questions Index </li>
            <li> Health Quizzes Index </li>
            <li> Health Topics Index </li>
            <li> Medicines Index </li>
            <li> Ailment Index </li>
            <li> Lab Test Details Index </li>
        </ul>
    </div>
    <div>
        <ul class="footer-list">
            <li class="footer-list-header"> Read about Lybrate </li>
            <li> About Us </li>
            <li> Contact Us </li>
            <li> Careers </li>
            <li> Mobile Apps </li>
