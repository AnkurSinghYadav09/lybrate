          ...
          let imageArr=[
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Apple-Cider-Vinegar-1200x250.jpg"},
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Swan-Lipolyzer-Fat-Burning-Oil-Web.jpg"},
            {I:"	https://assets.lybrate.com/q_auto,f_auto/rio/800x800/Swan-The-Weight-Cutter-Basic-Pack-web.jpg"},
            {I:"    https://assets.lybrate.com/q_auto,f_auto/rio/800x800/slim-herb-web1.jpg"},
           ...
           async function getData() {
                ...
                try{
                   let res = await fetch(`../API's/weight management.json`)
              ...
              document.querySelector("#search1").addEventListener("click", myfunction1)
                ...
                displayData(x);
                  ...
                  // here we have filtered brand
                     ...
                     function myfunctionB1(Lipolyzer){
                         var serch = "Lipolyzer"
                     ...
                     function myfunctionB2(Neuherbs){
                         var serch1 = "Neuherbs"
                     ...
                     function myfunctionB5(NutroActive){
                         var serch = "NutroActive"
                         var filterDeta = dt.filter(function(ele){
